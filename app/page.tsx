...
nav {
  ...
  background: rgba(8,8,8,0.85); backdrop-filter: blur(18px);
...
.nav-logo {
  ...
  letter-spacing: -0.02em; color: var(--white); cursor: pointer;
...
@media (max-width: 768px) {
  ...
  .mobile-register {
    margin-top: 8px; padding: 13px 20px; background: var(--blue); color: #fff;
...
@media (max-width: 900px) {
  .two-col, .two-col-left-wide { grid-template-columns: 1fr; gap: 32px; }
}
...
.hero-bg {
  ...
  background: radial-gradient(ellipse 60% 50% at 50% 0%, rgba(59,130,246,0.18) 0%, transparent 70%),
...
.hero-badge {
  ...
  padding: 6px 14px;
  background: var(--blue-dim); border: 1px solid rgba(59,130,246,0.3); border-radius: 99px;
...
.hero h1 {
  ...
  font-weight: 800; line-height: 0.95; letter-spacing: -0.04em; margin-bottom: 20px;
}
.hero h1 .accent {
...
.card-icon { width: 44px; height: 44px; background: var(--blue-dim); border: 1px solid rgba(59,130,246,0.2); border-radius: 10px; display: flex; align-items: center; justify-content: center; margin-bottom: 16px; font-size: 1.2rem; }
...
.prize-rank { font-size: 2rem; margin-bottom: 8px; }
.prize-amount { font-family: var(--font-display); font-size: 2.2rem; font-weight: 800; color: var(--blue-light); letter-spacing: -0.03em; }
.prize-place { font-size: 0.85rem; color: var(--grey); margin-top: 4px; font-weight: 500; }
...
.team-avatar {
  width: 64px; height: 64px; background: linear-gradient(135deg, var(--blue), var(--blue-light));
...
.footer-logo { font-family: var(--font-display); font-size: 1.2rem; font-weight: 800; letter-spacing: -0.02em; }
.footer-logo span { color: var(--blue); }
.footer-links { display: flex; gap: 20px; flex-wrap: wrap; }
.footer-link { font-size: 0.85rem; color: var(--grey); cursor: pointer; transition: color var(--transition); }
...
.criteria-bar { height: 100%; background: linear-gradient(90deg, var(--blue), var(--blue-light)); border-radius: 99px; transition: width 1s ease; }
.criteria-pct { font-size: 0.8rem; font-weight: 700; color: var(--blue-light); width: 38px; text-align: right; }

.tag { display: inline-flex; align-items: center; padding: 4px 10px; background: var(--blue-dim); border: 1px solid rgba(59,130,246,0.2); border-radius: 99px; font-size: 0.76rem; font-weight: 600; color: var(--blue-light); letter-spacing: 0.02em; }
...
.form-label { display: block; font-size: 0.82rem; font-weight: 600; color: var(--grey); margin-bottom: 6px; letter-spacing: 0.02em; }
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div className="fade-up-4" style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <button
              ...
              onClick={() => { setPage("competition"); window.scrollTo({ top: 0, behavior: "smooth" }); }}
            >
              Learn More
            </button>
          </div>
    ...
    <div className="page">
      ...
      <section className="section">
        <div className="container" style={{ textAlign: "center" }}>
          ...
          <p className="section-desc" style={{ margin: "0 auto 32px" }}>
            Registration is free. Complete the form to secure your spot.
          </p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "center", marginBottom: 40 }}>
            {[
              { t: "Teams of 3–5 students" },
              { t: "Open to all high school students" },
              { t: "Free to register" },
            ].map((item, idx) => (
              <div key={idx} style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 16px", background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: 99, fontSize: "0.875rem", fontWeight: 500 }}>
                <span>{item.t}</span>
              </div>
            ))}
          </div>
    ...
    <div className="page">
              ...
              <div className="team-card" key={i}>
                ...
                <div style={{ marginTop: 10 }}>
                  <span
                    ...
                    style={{
                      fontSize: "0.7rem",
                      background: p.tag === "Director" || p.tag === "Co-Director" ? "rgba(59,130,246,0.18)" : "rgba(96,165,250,0.12)",
                      color: p.tag === "Director" || p.tag === "Co-Director" ? "var(--blue-light)" : "rgba(150,200,255,0.85)",
                    }}
                  >
                    {p.tag}
                  </span>
      ...
      <section style={{ padding: "100px 0", background: "var(--bg)", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative", zIndex: 1, textAlign: "center" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "6px 16px", background: "rgba(59,130,246,0.15)", border: "1px solid rgba(59,130,246,0.35)", borderRadius: 99, fontSize: "0.78rem", fontWeight: 700, color: "var(--blue-light)", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 24 }}>
            Now Recruiting
          </div>
          <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, letterSpacing: "-0.03em", lineHeight: 1.1, marginBottom: 16 }}>
            Want to Join the<br />
            <span style={{ background: "linear-gradient(135deg, var(--blue) 0%, var(--blue-light) 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>Executive Team?</span>
          </h2>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 12, marginBottom: 40 }}>
            {["Real Organizing Experience", "Leadership Role", "Network with Students", "Certificate & Recognition"].map((perk, i) => (
              <div key={i} style={{ padding: "8px 16px", background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: 99, fontSize: "0.85rem", fontWeight: 500, color: "var(--grey)" }}>
                {perk}
              </div>
            ))}
          </div>
          <a
            ...
            style={{
              ...
              padding: "18px 48px", background: "var(--blue)", color: "#fff",
              borderRadius: 12, fontSize: "1.1rem", fontWeight: 700, textDecoration: "none",
            ...
            <div className="card" style={{ padding: 32 }}>
              {sent ? (
                <div className="success-box" style={{ padding: "32px 16px" }}>
                  <div className="success-icon" style={{ fontSize: "1.5rem" }}>✓</div>
